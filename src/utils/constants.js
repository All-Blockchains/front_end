export const TRON_API = "https://api.shasta.trongrid.io";
export const MAIN_TRON_API = "https://api.trongrid.io";

export const FOUNDATION_ADDRESS = 'TPCZzQSkKs1qXn6jbW9jsj81sBipxZQDac';
export const MAIN_FOUNDATION_ADDRESS = 'TBxZSq8sVYzHq4xVpfRodda3fEgpJMCJgG';

export const CONTRACT_ADDRESS = 'TMRqzuyg1Nr5GHQHTZGbvjgkGmj8gmjUJ6';
export const MAIN_CONTRACT_ADDRESS = 'THPgisMAwFuqfW7tFCVQrm81X6ktVM1whi';


export const DONT_ADDRESS = 'T9yD14Nj9j7xAB4dbGeiX9h8unkKHxuWwb';
export const ADDRESS_DEPOSIT = 'TFcmUxj43RUAkkPrQdDEm8KW5oNZJro1ZW';
